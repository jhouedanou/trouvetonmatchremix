...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))}><div class="container"><h2 class="title"> Choisissez votre ${ssrInterpolate(userTeam.value === "biere" ? "bière" : "soda")}</h2><div class="columns is-flex is-multiline"><!--[-->`);
...
//# sourceMappingURL=choix-boisson-DhxyfO1x.js.map
