import { hasInjectionContext, inject, version, unref, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, getCurrentInstance, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, shallowRef, isReadonly, toRaw, isRef, isShallow, isReactive } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/ofetch/dist/node.mjs';
...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/h3/dist/index.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/defu/dist/defu.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/unhead/dist/index.mjs';
...
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/bigfiveproduction/Documents/trouvetonmatchremix/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "choix-boisson",
    path: "/choix-boisson",
    component: () => import('./choix-boisson-DhxyfO1x.mjs'),
    children: [
      {
        name: "choix-boisson-id",
        path: ":id()",
        component: () => import('./_id_-CsZuuC8q.mjs')
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-7jtmS37q.mjs')
  },
  {
    name: "inscription",
    path: "/inscription",
    component: () => import('./inscription-CxDuTd5h.mjs')
  },
  {
    name: "match",
    path: "/match",
    component: () => import('./match-D6nchs6G.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BYHlzu3C.mjs'));
